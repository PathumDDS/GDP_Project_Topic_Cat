...
# --- CONFIGURATION ---
INPUT_FILE = "prediction/data_weekly/final_dataset/weekly_merged_data.csv"  
OUTPUT_FILE_WEEKLY = "prediction/data_weekly/weekly_preprocessed_data.csv"
...
def main():
    ...
    print(f"Success! data saved to: {OUTPUT_FILE_WEEKLY}")
