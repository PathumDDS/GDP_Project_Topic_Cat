...
# --- CONFIGURATION ---
TRENDS_FILE = "prediction/data_weekly/preprocessed_data.csv"
GDP_FILE = "prediction/data_weekly/gdp_sri_lanka.csv"
OUTPUT_FILE = "prediction/data_weekly/gdp_merged_data.csv"
